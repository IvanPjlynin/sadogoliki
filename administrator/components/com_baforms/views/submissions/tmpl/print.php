...
<div id="pdf-wrapper" style="background: #ffffff; padding: 25px; ">
    ...
    ?>
                <tr>
                    <td style="font-size: 16px;background: transparent;border: none;padding-top: 25px;line-height: 32px;padding: 25px 0 0;font-weight: bold;"><?php echo $message->title; ?>:</td>
                </tr>    
                <tr>    
