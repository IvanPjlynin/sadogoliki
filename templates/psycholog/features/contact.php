...
class HelixUltimateFeatureContact
{
	...
	public function renderFeature()
	{
		...
		if($conditions)
		{
			...
			{
				$output .= '<li class="sp-contact-phone"><span class="fas fa-phone" aria-hidden="true"></span> <a href="tel:' . str_replace(array(')', '(', ' ', '-'), array('', '', '', ''), $this->params->get('contact_phone')) . '">' . $this->params->get('contact_phone') . '</a>  <a target="_blank" href="https://wa.me/79260093849"><i class="fab fa-whatsapp" style="font-size: 17px;"></i>WhatsApp</a></li>';
			}
